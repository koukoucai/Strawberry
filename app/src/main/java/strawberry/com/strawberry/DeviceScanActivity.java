...
//        MainApplication.name = device.getName();
//        MainApplication.address =  device.getAddress();
//        startActivityForResult(new Intent(DeviceScanActivity.this, BlackActivity.class),100001);
        if (mScanning) {
