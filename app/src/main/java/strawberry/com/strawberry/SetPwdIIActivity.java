 ...
 * 输入密码的位置
 */
public class SetPwdIIActivity extends BaseActivity implements View.OnClickListener{
...
//        Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_RESET_PWDII+" 00 00"));
        ...
        keyBoardView.setOnResult(new KeyBoardView.OnResult() {
            ...
            public void submit(String result) {
                ...
                intent.putExtra(SetPwdActivity.PWDEDT1,pwd1);
                intent.putExtra(SetPwdActivity.PWDEDT2,pwd2);
...
//                    }
//                }else{
//                    Toast.makeText(SetPwdIIActivity.this,"设置密码不能为空",Toast.LENGTH_SHORT).show();
//                }
...
//                    startActivity(new Intent(SetPwdIIActivity.this,ResetSuccessActivity.class));
//                    //对密码清零
////                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_PWD+"00 00"));
//                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_RESET_PWDI+" 00 00"));
//                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_RESET_PWDII+" 00 00"));
...
//                    startActivity(new Intent(SetPwdIIActivity.this,ResetFailActivity.class));
//                    //对密码清零
//                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_RESET_PWDI+" 00 00"));
//                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_RESET_PWDII+" 00 00"));
////                    Utils.writeCharacteristic(MainApplication.getmBluetoothLeService(),target_chara,Utils.hexString2Bytes(UtilsKey.PAGE_CODE_PWD+"00 00"));
...
////                    submitPwd(false);
//                    Toast.makeText(SetPwdIIActivity.this,"这是第二行密码框输入  "+editText1.getText().toString(),Toast.LENGTH_LONG).show();
//                }
            }
        };
    }
